        ...
        <>
            ...
            <div className="bg-dark-layer-2 w-full py-4 px-4 text-white ">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-dark-layer-1 rounded-md py-4 px-4 min-w-[320px] md:min-w-[500px] max-h-[320px] md:max-h-full lg:min-w-[400]:">
                    ...
                    <div className="bg-dark-layer-1 rounded-md py-4 px-4 min-w-[320px] md:min-w-[500px] max-h-[320px] md:max-h-full">
